...
export const Header = () => {
  return (
    <header className="shadow-md flex z-100 justify-between flex-row fixed lg:bg-[rgba(255,255,255,01)]  bg-[#ffffff] px-5 py-1 top-20 lg:top-20 left-[50%] translate-[-50%] w-[80%] md:w-[80%] lg:w-[60%] xl:w-[75%] max-w-8xl rounded-2xl backdrop-blur-lg  items-center lg:text-1xl">
      ...
      {/*NAV MOBILE*/}
      <nav className="lg:hidden w-60 md:w-130 bg-[rgba(255,255,255,1)] text-black rounded-2xl z-101 fixed top-9 md:top-19 justify-center right-[-130%] transition-right duration-300 items-start p-5 nav-slide backdrop-blur-lg  ">
        <ul className="flex flex-col justify-between items-center gap-1 drop-shadow-md">
          <li className="p-2 mt-5 border-b w-full text-center hover:text-green-400 transition-colors duration-200 cursor-pointer">
